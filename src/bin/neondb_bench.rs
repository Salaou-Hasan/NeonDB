//! neondb-bench — Standalone WebSocket benchmark tool for NeonDB
//!
//! Usage:
//!   neondb-bench [OPTIONS]
//!
...
//!
//! Example:
//!   cargo run --release --bin neondb-bench -- \
...
#[command(
    name = "neondb-bench",
    about = "NeonDB WebSocket benchmark tool — measures round-trip TPS and latency percentiles",
    long_about = None,
)]
struct Args {
    /// WebSocket URL of the NeonDB server
...
impl Report {
    ...
    fn render(&self) -> String {
        ...
        out.push_str("# NeonDB Benchmark Report\n\n");
